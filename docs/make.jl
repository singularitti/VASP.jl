...
DocMeta.setdocmeta!(VASP, :DocTestSetup, :(using VASP); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/singularitti/VASP.jl/blob/{commit}{path}#{line}",
    sitename = "VASP.jl",
    format = Documenter.HTML(; canonical = "https://singularitti.github.io/VASP.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/singularitti/VASP.jl")
